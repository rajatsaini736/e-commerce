<?php
  ...
  if(!empty($_POST['ScatName']) && !empty($_POST['removeScat']))
  {
    ...
    $quer = "SELECT * FROM `sub_category` WHERE `name`='$ScatName';";
    ...
    if($check===0)
    {
       $catErr = "There are no Sub-category with this name";
    }
    else
    {
      $sq = "DELETE FROM `Sub_category` WHERE `name`='$ScatName'; ";
      if(mysqli_query($conn,$sq))
      { 
         $ScatSuc = "Sub-Category successfully removed";
      }
      else
      {
        $ScatErr = "Failed to remove Sub-category";
      }
    ...
    <form method="POST" enctype="multipart/form-data">
      ...
      <p style="color: green;">
            ...
            <div class="input-group mb-3">
             <select class="custom-select" id="inputGroupSelect03" name="ScatName">
          ...
          <input type="submit" class="btn btn-primary btn-block" name="removeScat" value="Remove">
